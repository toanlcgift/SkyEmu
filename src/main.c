...
#ifdef SE_PLATFORM_ANDROID
sapp_desc sokol_android_main(int argc, char* argv[]) {
    emu_state.cmd_line_arg_count = argc;
    emu_state.cmd_line_args = argv;
    int width = 1280;
    int height = 800;
...
SKYEMU_API int android_main(int argc, char* argv[]) {
    sapp_desc desc = sokol_android_main(argc, argv);
    _sapp_android_run(&desc);
    return 0;
}
#endif
