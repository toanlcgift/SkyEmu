...
SKYEMU_API void se_set_language(int language_enum);//i.e. SE_LANG_ENGLISH
SKYEMU_API const char* se_language_string(int language_enum);//returns "" if language is not supported
SKYEMU_API const char* se_localize(const char* string);
SKYEMU_API int se_convert_locale_to_enum(const char* clocale);
